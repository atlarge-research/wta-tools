...
class Resource(object):
    ...
    def get_parquet_dict(self):
        simple_dict = {
            ...
            "num_resources": np.float64(self.num_resources),
            "proc_model": np.str(self.proc_model),
            "memory": np.int64(self.memory),
            "disk_space": np.int64(self.disk_space),
            "network": np.int64(self.network),
            "os": np.str(self.os),
            "details": np.str(json.dumps(self.details)),
        }
