...
get_framework_registry().framework("hadoop").add_version(HadoopFrameworkVersion("3.2.4", "https://archive.apache.org/dist/hadoop/common/hadoop-3.2.4/hadoop-3.2.4.tar.gz", "tar.gz", "hadoop-3.2.4", "3.2.x"))
